...
run_experiments({
    'num_steps_network_structure_fine_nationwide_w25' : {
            'run': 'car_sales_prediction_trainable',
            'trial_resources': {'cpu': 8, 'gpu': 1},
            'stop': {'training_iteration': 60},
            'config' : {
                'line_id': 201,
                'keep_prob' : grid_search([0.7, 0.8, 0.9, 1.0]),
                'layer_0' : grid_search([26, 29, 31, 34]),
                'max_epoch' : 2,
                'window_size': 25,
                'store_window' : False,
...
'''run_experiments({
    'network_structure_2_layers_nationwide' : {
        ...
        'config' : {
            ...
            'layer_0' : grid_search([8, 12, 16]),
            'layer_1' : grid_search([8, 12, 16]),
            'num_steps': 12,
            'max_epoch' : 2,
            'window_size': 37,
            'store_window' : False,
...
'''run_experiments({
    'num_steps_coarse_nationwide_cfs' : {
            'run': 'car_sales_prediction_trainable',
            'trial_resources': {'cpu': 8, 'gpu': 1},
            ...
            'config' : {
                'line_id': 201,
                'keep_prob' : grid_search([0.7, 8.5, 1.0]),
                'layer_0' : grid_search([15, 18, 21, 24]),
                'max_epoch' : 2,
                'window_size': 37,
                'store_window' : False,
                'included_features' : ['inflation_index_roc_prev_month',
