...
class ModelTrainer():
    ...
    def _setup(self, config):
        ...
        self._reader = Reader(self._config['line_id'], self._config['window_size'], self._config['included_features'], self._config['predicted_features'], prediction_size=self._config['prediction_size'], base_ensembles=self._config['base_ensembles'], multi_month_prediction=self._config['multi_month_prediction'])
